...
public class Post extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4647317738998185053L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Post\",\"namespace\":\"sg.edu.smu.is459.authorcount\",\"fields\":[{\"name\":\"topic\",\"type\":\"string\"},{\"name\":\"author\",\"type\":\"string\"},{\"name\":\"content\",\"type\":\"string\"}]}");
   ...
   */
  public static sg.edu.smu.is459.authorcount.Post.Builder newBuilder() {
    return new sg.edu.smu.is459.authorcount.Post.Builder();
  }
   ...
   * @return A new Post RecordBuilder
   */
  public static sg.edu.smu.is459.authorcount.Post.Builder newBuilder(sg.edu.smu.is459.authorcount.Post.Builder other) {
    return new sg.edu.smu.is459.authorcount.Post.Builder(other);
  }
   ...
   * @return A new Post RecordBuilder
   */
  public static sg.edu.smu.is459.authorcount.Post.Builder newBuilder(sg.edu.smu.is459.authorcount.Post other) {
    return new sg.edu.smu.is459.authorcount.Post.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Post>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(sg.edu.smu.is459.authorcount.Post.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(sg.edu.smu.is459.authorcount.Post other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.topic)) {
        this.topic = data().deepCopy(fields()[0].schema(), other.topic);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public sg.edu.smu.is459.authorcount.Post.Builder setTopic(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sg.edu.smu.is459.authorcount.Post.Builder clearTopic() {
      topic = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sg.edu.smu.is459.authorcount.Post.Builder setAuthor(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sg.edu.smu.is459.authorcount.Post.Builder clearAuthor() {
      author = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sg.edu.smu.is459.authorcount.Post.Builder setContent(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sg.edu.smu.is459.authorcount.Post.Builder clearContent() {
      content = null;
