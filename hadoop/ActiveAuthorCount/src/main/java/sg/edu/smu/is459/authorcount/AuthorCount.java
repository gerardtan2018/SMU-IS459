package sg.edu.smu.is459.authorcount;
...
public class AuthorCount extends Configured implements Tool {

    public static class TokenizerMapper extends Mapper<LongWritable, Post, Text, IntWritable> {
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new AuthorCount(), args);
        System.exit(res);
    }
